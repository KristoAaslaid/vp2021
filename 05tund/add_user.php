    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        if(isset($_POST["user_data_submit"])){
			...
			if(isset($_POST["first_name_input"]) and !empty($_POST["first_name_input"])){
				$firstname = validate(filter_var($_POST["first_name_input"], FILTER_SANITIZE_STRING));
				if(empty($firstname)){
			...
			$surname = validate(filter_var($_POST["surname_input"], FILTER_SANITIZE_STRING));
			if(empty($surname)){
			...
			$birth_day = validate(filter_var($_POST["birth_day_input"], FILTER_VALIDATE_INT));
			...
			$birth_month = validate(filter_var($_POST["birth_month_input"], FILTER_VALIDATE_INT));
			...
			$birth_year = validate(filter_var($_POST["birth_year_input"], FILTER_VALIDATE_INT));
			...
			if(isset($_POST["confirm_password_input"]) and !empty($_POST["confirm_password_input"])){
				if($_POST["confirm_password_input"] != $_POST["password_input"]){
					$confirm_password_error = "Ei klapi, lol.";
				}
			} else {
