    ...
    //kas klikiti submit nuppu
		if(isset($_POST["film_submit"])){
			...
			if(!empty($_POST["title_input"])){
				$title_input = validate(filter_var($_POST["title_input"], FILTER_SANITIZE_STRING));
			} else {
			...
			if(!empty($_POST["genre_input"])){
				$genre_input = validate(filter_var($_POST["genre_input"], FILTER_SANITIZE_STRING));
			} else {
				$genre_input_error = "Palun sisesta filmi žanr!";
			}
			if(!empty($_POST["studio_input"])){
				$studio_input = validate(filter_var($_POST["studio_input"], FILTER_SANITIZE_STRING));
			} else {
				$studio_input_error = "Palun sisesta filmi tootja!";
			}
			if(!empty($_POST["director_input"])){
				$director_input = validate(filter_var($_POST["director_input"], FILTER_SANITIZE_STRING));
			} else {
