<?php
	...
	if(isset($_POST["person_photo_submit"])){
		...
		if($image_check !== false){
			...
			if move_uploaded_file($_FILES["photo_input"]["tmp_name"], $person_photo_dir .$file_name){ //var_dump'ist sai kätte need
		...
		//move_uploaded_file($_FILES["photo_input"]["tmp_name"], $person_photo_dir . $_FILES["photo_input"]["name"]);  //var_dump'ist sai kätte need
	}
